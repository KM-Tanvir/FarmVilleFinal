...
<head>
  ...
  <title>FarmVille — Feedback</title>
...
.form-control:focus {
  ...
  box-shadow: 0 0 0 2px rgba(44, 141, 173, 0.2);
}
...
<div class="sidebar" id="sidebar">
  ...
  <a href="customer-market-insights.php"><i class="fas fa-chart-line"></i> Market Insights</a>
  <a href="customer-order-history.php"><i class="fas fa-history"></i> My Orders</a>
  <a href="customer-feedback.php" class="active"><i class="fas fa-comment-alt"></i> Feedbacks</a>
...
<div class="main-content">
  <section class="content-box">
    ...
    <p class="text-center" style="margin-bottom: 30px;">We value your opinion! Please share your experience with FarmVille.</p>
    
    <div id="feedbackFormContainer" class="feedback-form">
      <form id="feedbackForm">
        <div class="form-group">
          <label for="feedbackName" class="form-label">Your Name</label>
          <input type="text" class="form-control" id="feedbackName" placeholder="Enter your name" required>
        </div>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="feedbackComments" placeholder="Tell us about your experience..." required></textarea>
        </div>
        
        <div class="form-group">
          <label for="feedbackSuggestions" class="form-label">Suggestions for Improvement</label>
          <textarea class="form-control" id="feedbackSuggestions" placeholder="How can we improve our service?"></textarea>
        </div>
    ...
    <div id="thankYouMessage" class="thank-you">
      ...
      <button id="submitAnother" class="btn" style="margin-top: 20px;">Submit Another Feedback</button>
    </div>
  </section>
</div>
